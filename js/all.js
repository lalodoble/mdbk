...
; (function ($, window, document, underfined) {
	...
	/* INTERNAL MENU */
	/**********************************/
	$('.internal-menu a').on('click', function (e) {
		var thisItem = $(this);
		var link = thisItem.attr('data-target');

		$('.internal-menu-container a').removeClass('active');
		thisItem.addClass('active');

		var headerH = $('.prague-header').outerHeight() + $('.internal-menu-container').outerHeight();
		$('html, body').animate({ scrollTop: $('#' + link).offset().top - headerH }, 'slow');
	})
